...
const GlimpsOfMaa = () => {
  ...
  return (
    <div className="bg-black py-10">
      <motion.h2
        className="text-[3.4rem] font-bold w-3/5 mx-auto uppercase text-center text-[#ff8127]"
        {...fadeUp()}
      >
      ...
      <motion.div className="mt-10 w-3/5 mx-auto" {...fadeUp()}>
        <p className="font-bold text-[#86868b] indent-50 pb-5 text-justify leading-8.5 ">
          For briefing <span className="text-white font-extrabold">Mother VISHVAMBHARI</span>,
        ...
        <p className="font-bold text-[#86868b] indent-50 pb-5 text-justify leading-8.5">
          ...
          <span className="text-white font-extrabold">Universe and entire world.</span> Mother
          created{" "}
          <span className="text-white font-extrabold">
          ...
          her <span className="text-white font-extrabold">Extra-terrestrial power</span>.
