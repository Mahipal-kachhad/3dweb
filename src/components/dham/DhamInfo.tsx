...
const DhamInfo = () => {
  ...
  return (
    <div className="bg-black pb-10">
      <motion.h2
        className="text-4xl font-bold w-3/5 mx-auto uppercase text-center text-[#ff8127]"
        {...fadeUp()}
      >
        Maa Vishvambhari TirthYatra Dham
      </motion.h2>
      <div className="">
        <motion.div className="mt-10 w-3/5 mx-auto" {...fadeUp()}>
          ...
          <p className="font-bold text-[#86868b] indent-50 pb-5 text-justify leading-8.5">
            ...
            and she is also the creator of minutest lifes to the gigantic
            animals; small mote to skyward ranges of Himalayas; small drop of
            water to seven seas; skies covering little cloud to stars, planets
            and nebulas. By arranging mysterious play of evolution,{" "}
            <span className="text-white font-extrabold">
            ...
            . Mother VISHVAMBHARI is the mother of all Gods and Goddesses. She
            is omnipresent, almighty and omniscient.
          </p>
          <p className="font-bold text-[#86868b] indent-50 pb-5 text-justify leading-8.5">
          ...
          <p
            className="text-end text-[#FF8127] flex w-fit ms-auto gap-3 items-center pe-4 pt-10 cursor-pointer"
      ...
      <BlurPopup isOpen={isOpen} setIsOpen={setIsOpen}>
        <h2 className="text-6xl font-bold text-[#ff8127] text-center mb-10 uppercase">
          Maa Vishvambhari
        </h2>
